...
fun test_create_registry() {
    ...
    test_scenario::next_tx(&mut scenario, ALICE);
    {
        ...
        let (registry, cap) = payment_standard::create_registry(
            &mut namespace,
...
fun test_successful_payment_exact_amount() {
    ...
    {
        let mut namespace = test_scenario::take_shared<payment_standard::Namespace>(&scenario);
        let (mut registry, cap) = payment_standard::create_registry(
            &mut namespace,
            std::ascii::string(b"testregistry"),
            test_scenario::ctx(&mut scenario),
        );
        ...
        let _receipt = payment_standard::process_payment_in_registry<SUI>(
            &mut registry,
...
#[test, expected_failure(abort_code = 1, location = payment_standard)]
...
#[test, expected_failure(abort_code = 0, location = payment_standard)]
fun test_duplicate_payment_hash_failure() {
    ...
    test_scenario::next_tx(&mut scenario, ALICE);
    {
        ...
        payment_standard::set_registry_config(
            &mut registry,
            &cap,
            config,
            test_scenario::ctx(&mut scenario),
        ...
        let _receipt1 = payment_standard::process_payment_in_registry<SUI>(
            &mut registry,
        ...
        let _receipt2 = payment_standard::process_payment_in_registry<SUI>(
            &mut registry,
...
fun test_multiple_different_nonces() {
    ...
    test_scenario::next_tx(&mut scenario, ALICE);
    {
        ...
        let _receipt3 = payment_standard::process_payment_in_registry<SUI>(
            &mut registry,
...
#[test, expected_failure(abort_code = 2, location = payment_standard)]
...
#[test, expected_failure(abort_code = 3, location = payment_standard)]
...
fun test_valid_registry_names() {
    ...
    test_scenario::next_tx(&mut scenario, ALICE);
    {
        ...
        let (registry1, cap1) = payment_standard::create_registry(
            &mut namespace,
        ...
        let (registry2, cap2) = payment_standard::create_registry(
            &mut namespace,
        ...
        let (registry3, cap3) = payment_standard::create_registry(
            &mut namespace,
...
#[test, expected_failure(abort_code = 7, location = payment_standard)]
...
#[test, expected_failure(abort_code = 6, location = payment_standard)]
...
#[test, expected_failure(abort_code = 4, location = payment_standard)]
fun test_set_config_unauthorized() {
    ...
    {
        let mut namespace = test_scenario::take_shared<payment_standard::Namespace>(&scenario);
        let (mut registry, bob_cap) = payment_standard::create_registry(
            &mut namespace,
            std::ascii::string(b"testregistry"),
            test_scenario::ctx(&mut scenario),
        );
        ...
        test_scenario::next_tx(&mut scenario, ALICE);
        {
            ...
            let (alice_registry, alice_cap) = payment_standard::create_registry(
                &mut namespace,
...
#[test, expected_failure(abort_code = 8, location = payment_standard)]
